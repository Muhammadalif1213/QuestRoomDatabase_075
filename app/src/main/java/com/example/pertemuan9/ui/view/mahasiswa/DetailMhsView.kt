...
import com.example.pertemuan9.ui.viewmodel.DetailUitate
import com.example.pertemuan9.ui.viewmodel.toMahasiswaEntity


@Composable
fun BodyDetailMhs(
    modifier: Modifier = Modifier,
    detailUitate: DetailUitate = DetailUitate (),
    onDeleteClick: () -> Unit = {}
){
    var deleteConfifrmationRequired by rememberSaveable { mutableStateOf(false) }
    when{
        detailUitate.isLoading ->{
            Box(
        ...
        detailUitate.isUiEventNotEmpty -> {
            Column (
                modifier = modifier
                    .fillMaxWidth()
                    .padding(16.dp)
                ...
                ItemDetailMhs(
                    mahasiswa = detailUitate.detailUiEvent.toMahasiswaEntity(),
                    modifier = Modifier
                )
